...
- (NSString *)orderHeaderString
{
    ...
    NSString *weekString = [NSDate getWeekStringFromInteger:weekIntValue];
    return [NSString stringWithFormat:@"%@%@", destDateString, weekString];
}
