...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(SCREEN_SHORT, 73.0f);//头部视图的框架大小
        
        CGFloat height = IS_SMALL_WIDTH_SCREEN_IPHONE ? (IS_SMALL_SCREEN_IPHONE ? 57.0 : 65.0) : 75.0;
        self.itemSize = CGSizeMake(SCREEN_SHORT/7, height);//每个cell的大小
