...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(.0, .0, SCREEN_SHORT, 48.0)];
    [masterLabel setBackgroundColor:UIColorFromRGB(0x64CEA9)];
    ...
    CGFloat yOffset = 48.0f;
    CGFloat dayLabelWidth = (SCREEN_SHORT - 40.0) / 7;

    UIView *dayOfTheWeekBackgroundView = [[UILabel alloc] initWithFrame:CGRectMake(.0, 48.0, SCREEN_SHORT, 25.0)];
    [dayOfTheWeekBackgroundView setBackgroundColor:UIColorFromRGB(0xC9F1E8)];
    [self addSubview:dayOfTheWeekBackgroundView];

    //一，二，三，四，五，六，日
    UILabel *dayOfTheWeekLabel = [[UILabel alloc]initWithFrame:CGRectMake(xOffset,yOffset, dayLabelWidth, CATDayLabelHeight)];
    [dayOfTheWeekLabel setBackgroundColor:[UIColor clearColor]];
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:12.0f]];
    ...
    xOffset += dayLabelWidth + 5.0f;
    dayOfTheWeekLabel = [[UILabel alloc]initWithFrame:CGRectMake(xOffset,yOffset, dayLabelWidth, CATDayLabelHeight)];
    [dayOfTheWeekLabel setBackgroundColor:[UIColor clearColor]];
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:12.0f]];
